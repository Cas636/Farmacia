...
public class print extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        form_print.setBackground(new java.awt.Color(148, 211, 196));
        ...
        jPanel1.add(txt_invoice, new org.netbeans.lib.awtextra.AbsoluteConstraints(510, 20, 100, -1));
        ...
        if (purchase_details_table.getColumnModel().getColumnCount() > 0) {
            ...
            purchase_details_table.getColumnModel().getColumn(5).setMinWidth(100);
        ...
        form_print.add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(440, 450, -1, -1));

        txt_total.setEditable(false);
        form_print.add(txt_total, new org.netbeans.lib.awtextra.AbsoluteConstraints(500, 450, 120, 30));
        ...
        getContentPane().add(btn_print_purchase, new org.netbeans.lib.awtextra.AbsoluteConstraints(210, 570, 160, -1));
